package com.megotechnologies.conference_retronight.sections;
...
import com.megotechnologies.conference_retronight.FragmentMeta;
import com.megotechnologies.conference_retronight.MainActivity;
import com.megotechnologies.conference_retronight.R;
import com.megotechnologies.conference_retronight.interfaces.ZCFragmentLifecycle;
import com.megotechnologies.conference_retronight.interfaces.ZCRunnable;
import com.megotechnologies.conference_retronight.utilities.ImageProcessingFunctions;
import com.megotechnologies.conference_retronight.utilities.MLog;
...
public class FragmentNewsItemsListBackup extends FragmentMeta implements ZCFragmentLifecycle, ZCRunnable {
        ...
        tvLoadMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tvLoadMore.getText().toString().contains(MainActivity.LOAD_MORE_CAPTION_END)) {
                    ...
                    thLoadMore = new Thread(FragmentNewsItemsListBackup.this);
                    thLoadMore.setName(MainActivity.TH_NAME_LOAD_MORE);
                    thLoadMore.start();

                    threadLoadMoreChecker = new Thread(FragmentNewsItemsListBackup.this);
